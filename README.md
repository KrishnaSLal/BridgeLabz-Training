...
🔗 *Code Link:*  
👉 [Day 4 – Java Control Flows Practice](https://github.com/KrishnaSLal/BridgeLabz-Training/tree/core-java-practice/gcr-codebase/control-flow)
...
🔗 *Code Link:*  
👉 [Day 5 – Java Arrays Practice](https://github.com/KrishnaSLal/BridgeLabz-Training/tree/core-java-practice/gcr-codebase/arrays)
...
### 📅 Day 7 – Practiced Scenario-based Problems  of OOPS
*(Date: 02-Jan-2026)* 
...
### 📅 Day 8 – Practiced Scenario-based Problems of OOPS
*(Date: 03-Jan-2026)* 
...
- Categories of Patterns (GoF classification)
  ...
  🔗*Code Link* <br>
👉 [Day 1 - Design Pattern](https://github.com/KrishnaSLal/BridgeLabz-Training/tree/java-design-pattern-practice/java-design-pattern-practice/gcr-codebase/JavaDesigningPractice/src/com/designpattern/librarymanagementsystem)

---

### 📅 Day 2  – Design Principles & Design PAtterns
*(Date: 02-Feb-2026)*
...
🔗*Code Link* <br>
👉 [Day 2 - Multithreading](https://github.com/KrishnaSLal/BridgeLabz-Training/tree/java-design-pattern-practice/java-design-pattern-practice/gcr-codebase/JavaDesigningPractice/src/com/multithreading)
...
- Various Query Languages
  ...
  - TCL
- Explored Subqueries
- Explored Advanced SQL Concepts

🔗*Code Link* <br>
👉 [Day 1 - MySQL](https://github.com/KrishnaSLal/BridgeLabz-Training/tree/dbms-jdbc-practice/dbms-jdbc-practice/gcr-codebase/DBMSJDBCConcept/src/main/resources/com/dbmsjdbc/sql)
...
- Overview of JDBC
- Learnt how to implement connection in JDBC
- Practiced JDBC Problems: 
  ...
  🔗*Code Link* <br>
👉 [Day 2 - JDBC](https://github.com/KrishnaSLal/BridgeLabz-Training/tree/dbms-jdbc-practice/dbms-jdbc-practice/gcr-codebase/DBMSJDBCConcept/src/main/java/com/dbmsjdbc/jdbc)
...
- Different types of DBMS - Relational vs Non-Relational.
- Introduction to MySQL and RDBMS concepts.
- DDL (Data Definition Language) and DML (Data Manipulation Language).
- Implemented HealthClinic database using DDL and DML.

👉 [Day 1 - DBMS Fundamentals](https://github.com/KrishnaSLal/BridgeLabz-Training/tree/refresher-training/refresher-training/Day-1)
...
-  Created ER Diagram for the Health Clinic App.
-  Normalized the patient/doctor/appointment schema.
  
👉 [Day 2 - ER Diagram & Normalization](https://github.com/KrishnaSLal/BridgeLabz-Training/tree/refresher-training/refresher-training/Day-2)
